...
隨後將 AWS CloudShell 裡面的 observability-demo-rum-sourcemap-2.3.5.zip 檔案下載到瀏覽器預設下載目錄：
...
產生的檔案位於 `dist/observability-demo-rum-sourcemap-2.3.5.zip`。進入剛剛建立的 RUM 應用設定，在 **SourceMap** 頁面上傳該壓縮包，並填寫：

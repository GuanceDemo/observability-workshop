...
1. **TrueWatch Cloud Account:**
   - Register at [https://id1-auth.truewatch.com/businessRegister](https://id1-auth.truewatch.com/businessRegister) and create a workspace (default Commercial Version).

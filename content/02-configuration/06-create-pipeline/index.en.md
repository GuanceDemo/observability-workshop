...
The `message` field contains custom log entries. To parse these logs, choose "Manual" and paste the following pipeline script into the **Define Parsing Rules** section and click **Test**:
